...
if args.input_drug1 and args.input_drug2 != None:
    ...
    testingresult = model.predict_proba(testingvector.reshape(1,-1))
    print('the probability of the interaction of',args.input_drug1,'and',args.input_drug2,'is:',testingresult)
